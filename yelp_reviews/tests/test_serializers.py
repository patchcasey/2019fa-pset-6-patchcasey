...
class SerializerTests(DJTest):
    ...
    def test_contains_expected_fields(self):
        ...
        self.assertEqual(list(fact_data.keys()), ['cool', 'funny', 'stars', 'useful', 'count'])
    ...
    def test_fields_ByYearSerializer(self):
        ...
        self.assertEqual(list(byyear_data.keys()), ['year', 'total_count', 'avg_star',
                                                    'cool', 'avg_funny', 'avg_useful'])
