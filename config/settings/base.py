...
)  # (pset_6/config/settings/base.py - 3 = pset_6/)
APPS_DIR = ROOT_DIR.path("pset_6")
...
DATABASES = {
    "default": env.db("DATABASE_URL", default="postgres://localhost/pset_6")
}
...
ADMINS = [("""Casey Patch""", "patchcasey@gmail.com")]
